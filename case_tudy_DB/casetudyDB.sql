...
mo_ta_tien_nghi_khac varchar(200),
...
insert into `case_study`.`nhan_vien` (`ho_ten`, `ngay_sinh`, `so_cmnd`, `luong`, `so_dien_thoai`, `email`, `dia_chi`, `ma_vi_tri`, `ma_trinh_do`, `ma_bo_phan`) values 
...
insert into `case_study`.`loai_khach` (`ma_loai_khach`, `ten_loai_khach`) VALUES ('Diamond'),('Platinium'),('Gold'),('Silver'),('Member');

insert into `case_study`.`khach_hang` (`ho_ten`, `ngay_sinh`, `gioi_tinh`, `so_cmnd`, `so_dien_thoai`, `email`, `dia_chi`, `ma_loai_khach`) values 
...
insert into `case_study`.`dich_vu` (`ten_dich_vu`, `dien_tich`, `chi_phi_thue`, `so_nguoi_toi_da`, `tieu_chuan_phong`, `mo_ta_tien_nghi_khac`, `dien_tich_ho_boi`, `so_tang`, `ma_kieu_thue`, `ma_loai_dich_vu`) values 
('Villa Beach Front', '25000', '10000000', '10', 'vip', 'Có hồ bơi', '500', '4', '3', '1');
insert into `case_study`.`dich_vu` (`ten_dich_vu`, `dien_tich`, `chi_phi_thue`, `so_nguoi_toi_da`, `tieu_chuan_phong`, `mo_ta_tien_nghi_khac`, `so_tang`, `ma_kieu_thue`, `ma_loai_dich_vu`) values 
('House Princess 01', '14000', '5000000', '7', 'vip', 'Có thêm bếp nướng', '3', '2', '2');
insert into `case_study`.`dich_vu` (`ten_dich_vu`, `dien_tich`, `chi_phi_thue`, `so_nguoi_toi_da`, `tieu_chuan_phong`, `mo_ta_tien_nghi_khac`, `ma_kieu_thue`, `ma_loai_dich_vu`) values 
...
insert into `case_study`.`dich_vu_di_kem` (`ten_dich_vu_di_kem`, `gia`, `don_vi`, `trang_thai`) values 
...
insert into `case_study`.`hop_dong` (`ma_hop_dong`, `ngay_lam_hop_dong`, `ngay_ket_thuc`, `tien_dat_coc`, `ma_nhan_vien`, `ma_khach_hang`, `ma_dich_vu`) values 
...
INSERT INTO `case_study`.`hop_dong_chi_tiet` (`so_luong`, `ma_hop_dong`, `ma_dich_vu_di_kem`) VALUES
('5', '2', '4'),
('8', '2', '5'),
('15', '2', '6'),
('1', '3', '1'),
